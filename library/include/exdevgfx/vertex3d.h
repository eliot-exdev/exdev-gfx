...
typedef EXDEV_FLOAT Vertex3d_t[3];
...
void vertex3d_mul(const Vertex3d_t src, EXDEV_FLOAT f, Vertex3d_t res);

void vertex3d_div(const Vertex3d_t src, EXDEV_FLOAT f, Vertex3d_t res);
