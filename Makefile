# --- mos vbcc ---#
CC_VC=vc
C_FLAGS_MOS_VC=-O3 -speed -final -DNDEBUG -D__MORPHOS__
LD_FLAGS_MOS_FPU_VC=-lm
LD_FLAGS_MOS_NO_FPU_VC=

#--- mos gcc ---#
CC_GCC=ppc-morphos-gcc-11
C_FLAGS_MOS_FPU_GCC=-O3 -noixemul -mcpu=G4 -maltivec -mabi=altivec -DNDEBUG -D__MORPHOS__
C_FLAGS_MOS_NO_FPU_GCC=-O3 -noixemul -mcpu=G4 -maltivec -mabi=altivec -DNDEBUG -D__MORPHOS__ -DEXDEV_FP_MATH
LD_FLAGS_MOS_FPU_GCC=-lm
LD_FLAGS_MOS_NO_FPU_GCC=

#--- aos vc ---#
CC_VC=vc
C_FLAGS_060_FPU_VC=+aos68k -fpu=68060 -cpu=68060 -O3 -speed -final -DNDEBUG -D__AMIGA__
C_FLAGS_060_NO_FPU_VC=+aos68k -fpu=0 -cpu=68060 -O3 -speed -final -DNDEBUG -D__AMIGA__
LD_FLAGS_060_FPU_VC=-lm060
LD_FLAGS_060_NO_FPU_VC=

#--- includes ---#
INCLUDES_MOS_FPU=-Ilibrary/include -Ilibrary/easing/include
INCLUDES_MOS_NO_FPU=-Ilibrary/include -Ilibrary/easing/include -Ilibrary/fpmath/include

INCLUDES_060_FPU=-Ilibrary/include -Ilibrary/easing/include
INCLUDES_060_NO_FPU=-Ilibrary/include -Ilibrary/easing/include -Ilibrary/fpmath/include
...
voxelspace_mos_ppc_fpu_vc: library/src/vertex3d.c library/src/events.c library/src/vertex2d.c library/src/matrix.c library/src/palette.c library/src/color.c library/src/framebuffer.c library/src/framebuffer_8bit.c library/src_amiga/window_amiga.c library/src/font.c library/src/heightmap.c\
                library/src/voxelspace.c library/src/args.c library/src/helper.c library/src_amiga/exdev_base_amiga.c library/src_amiga/helper_amiga.c examples/voxelspace_main.c
	$(CC_VC) -o ${@} ${INCLUDES_MOS_FPU} $(^) ${C_FLAGS_MOS_VC} ${LD_FLAGS_MOS_FPU_VC}
...
voxelspace_mos_ppc_nofpu_vc: library/src/vertex3d.c library/src/events.c library/src/vertex2d.c library/src/matrix.c library/src/palette.c library/src/color.c library/src/framebuffer.c library/src/framebuffer_8bit.c library/src_amiga/window_amiga.c library/src/font.c library/src/heightmap.c\
                library/src/voxelspace.c library/src/args.c library/src/helper.c library/src_amiga/exdev_base_amiga.c library/src_amiga/helper_amiga.c examples/voxelspace_main.c
	$(CC_VC) -o ${@} ${INCLUDES_MOS_NO_FPU} $(^) ${C_FLAGS_MOS_VC} ${LD_FLAGS_MOS_NO_FPU_VC}
...
dist_voxelspace: voxelspace
	Delete ${PREFIX}voxelspace ALL
	Delete ${PREFIX}voxelspace.lha
	...
	Copy voxalspace#? ${PREFIX}voxelspace
